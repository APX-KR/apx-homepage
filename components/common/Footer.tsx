...
const FooterLink: React.FC<{ href: string, children: React.ReactNode }> = ({ href, children }) => (
    <a href={href} className="text-gray-300 hover:text-white transition-colors duration-300 text-body-sm">
        {children}
    </a>
);
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-10 gap-12">
                    ...
                    <div className="lg:col-span-4 text-body-sm text-gray-300">
                        ...
                        <div className="space-y-2">
                            ...
                            <p><span className="font-semibold text-white">대표이사</span> 김혜숙</p>
                            <p><span className="font-semibold text-white">사업자등록번호</span> 368-87-03618</p>
                            <p><span className="font-semibold text-white">본사</span> 06234 서울특별시 강남구 테헤란로 128, 317호</p>
                            <p><span className="font-semibold text-white">이메일</span> support@apxc.co.kr</p>
                        </div>
                    </div>
