...
const ContactModal: React.FC = () => {
    ...
    const [inquiryType, setInquiryType] = useState('솔루션 도입');
    ...
    const isFormValid = name && company && email && message && agreed;
                ...
                {isSubmitted ? (
                    ...
                    <>
                        <div className="p-6 md:p-8 border-b border-border-light">
                            <h3 className="text-h3 font-bold text-strategy-blue leading-tight tracking-tight-title">문의하기</h3>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 md:p-8 overflow-y-auto space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                 ...
                                 <div>
                                    <label htmlFor="phone" className="block text-body-sm font-medium text-text-secondary mb-1">연락처</label>
                                    <input type="tel" id="phone" value={phone} onChange={e => setPhone(e.target.value)} className="w-full px-3 py-2 border border-border-light rounded-md focus:outline-none focus:ring-2 focus:ring-strategy-blue" />
                                </div>
                                <div>
                            ...
                            <div className="flex items-start">
                                ...
                                <label htmlFor="agreed" className="ml-2 text-body-sm text-text-secondary">
                                    <a href="#" className="underline hover:text-text-primary">개인정보 수집 및 이용</a>에 동의합니다. <span className="text-error">*</span>
                                </label>
                            </div>
                        </form>
